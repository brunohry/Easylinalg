@testset verbose = true "Arrow3D Testes" begin
    ...
    @testset "EasyLinalg" begin
        ...
        @test (Arrow3D(1.0, 2.0, 3.0) + Arrow3D(3.0, 6.0, 9.0 ) ) / 2.0 ==  Arrow3D(2.0, 4.0, 6.0)
        ...
        @test ([ Arrow3D(-1.0, -11.0, -3.0), Arrow3D(1.0, 1.0, 0.0 ), Arrow3D(2.0, 5.0, 1.0 )  ]) \ (([ Arrow3D(-1.0, -11.0, -3.0), Arrow3D(1.0, 1.0, 0.0 ), Arrow3D(2.0, 5.0, 1.0 )  ]) * [ 1.0, 2.0, 3.0]) ≈  [ 1.0, 2.0, 3.0]
    end;
end;    
